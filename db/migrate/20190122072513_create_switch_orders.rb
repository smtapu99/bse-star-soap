class CreateSwitchOrders < ActiveRecord::Migration[5.2]
  def change
    create_table :switch_orders do |t|
      ...
      t.string :from_scheme_code, null: false #BSE scheme code
      t.string :to_scheme_code, null: false #BSE scheme code
      ...
      t.string :switch_amount #Switch amount
      t.string :switch_units #Switch units
      t.string :all_units_flag, default: 'N', null: false #Y/N, all units flag, If this Flag is "Y" then units and amount column should be blank
      t.string :folio_no, default: nil, null: true #In case demat transaction this field will be blank and mandatory in case of physical redemption and purchase+additional
      ...
      t.string :euin_val, default: 'Y', null: false #Y/N, EUIN declaration
